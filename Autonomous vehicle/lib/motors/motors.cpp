...
void updatePIpositionController(){
  ...
  robot.rightPIDspeed.setPoint = constrain(rightPosPI.value + robot.rightPIDposition.minSpeed*sgn(rightPosPI.value), -PI, PI);
...
void updatePIspeedController(){
  ...
  robot.rightMotor.dutyCycle = constrain(rightPI.value + robot.rightPIDspeed.coulombFriction*sgn(robot.rightPIDspeed.setPoint),-100,100);
